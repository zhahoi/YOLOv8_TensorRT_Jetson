...
int main(int argc, char** argv)
{
   // cuda:0
    ...
    while (true) {
        ...
        yolov8_obb->preprocessGPU(image);
        ...
        // yolov8_obb->postprocessGPU(objs, score_thres, iou_thres, topk);
...
int main(int argc, char** argv)
{
    ...
    // 保存推理结果
    std::string out_path = "/home/nvidia/Repository/yolov8_obb/build/result.jpg";
