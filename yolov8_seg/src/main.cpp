...
int main(int argc, char** argv)
{
    ...
    int topk = 100, seg_h = 160, seg_w = 160, seg_channels = 32;
    float score_thres = 0.25f, iou_thres = 0.65f;
    ...
    while (true) {
        ...
        yolov8_seg->preprocessGPU(image);
        ...
        yolov8_seg->postprocessGPU(objs, score_thres, iou_thres, topk, seg_channels, seg_h, seg_w);
...
int main(int argc, char** argv)
{
    ...
    // 保存推理结果
    std::string out_path = "/home/nvidia/Repository/yolov8_seg/build/result.jpg";
